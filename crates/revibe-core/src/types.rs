...
impl AgentStats {
    ...
    pub fn add_message_tokens(&mut self, msg: &revibe_llm::LlmMessage) {
    ...
    pub fn calculate_context_tokens(messages: &[revibe_llm::LlmMessage]) -> u32 {
        messages
            .iter()
